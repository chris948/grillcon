...
# class FilePaths:
#     def __init__(self, config_file_name, key_file_name):
#         # path = os.path.dirname(os.path.realpath(__file__))
#
#         self.config_file = os.path.join(path, config_file_name)
#         self.key_file = os.path.join(path, key_file_name)
...
#
# grillcon_off_file = "/views/grillcon_main_off.tpl"
# grillcon_on_file = "/views/grillcon_main_on.tpl"
# grillcon_history_file = "/views/grillcon_history.tpl"
# grillcon_admin_file = "/views/grillcon_admin.tpl"
#
# grillcon_off_template = path + grillcon_off_file
# grillcon_on_template = path + grillcon_on_file
# grillcon_history_template = path + grillcon_history_file
# grillcon_admin_template = path + grillcon_admin_file
